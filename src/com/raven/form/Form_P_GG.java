...
public class Form_P_GG extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblpggct.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ GIẢM GIÁ", "TÊN GIẢM GIÁ", "GIÁ TRỊ GIẢM", "HOÁ ĐƠN TỐI THIỂU", "LOẠI GIẢM GIÁ", "NGÀY KẾT THÚC"
            }
        ));
        ...
        tblall.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "MÃ GIẢM GIÁ", "TÊN GIẢM GIÁ", "GIÁ TRỊ GIẢM", "ĐƠN HÀNG TỐI THIỂU", "NGÀY BẮT ĐẦU", "NGÀY KẾT THÚC", "NGÀY TẠO", "LOẠI MÃ", "NGƯỜI TẠO"
            }
        ));
